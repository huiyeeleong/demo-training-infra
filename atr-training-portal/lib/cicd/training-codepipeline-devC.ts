...
export class TrainingCodePipelineC extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    super(scope, id, props);

    // Reference an existing CodeCommit repository by name
    const repo = codecommit.Repository.fromRepositoryName(this, 'ExistingMyRepository', 'atr-training-repo-c');

    // ECR repository
    const ecrRepo = ecr.Repository.fromRepositoryName(this, 'ExistingECRRepo', 'atr-training-ecr-c');
    ...
    const pipeline = new codepipeline.Pipeline(this, 'ATRTraningPipeline', {
      pipelineName: 'ATRTraningPipelineDevC',
