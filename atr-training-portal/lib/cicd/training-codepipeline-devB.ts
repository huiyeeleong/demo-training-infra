...
export class TrainingCodePipelineB extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    // ECR repository
    const ecrRepo = ecr.Repository.fromRepositoryName(this, 'ExistingECRRepo', 'atr-training-ecr-b');
    ...
    const pipeline = new codepipeline.Pipeline(this, 'ATRTraningPipeline', {
      pipelineName: 'ATRTraningPipelineDevB',
